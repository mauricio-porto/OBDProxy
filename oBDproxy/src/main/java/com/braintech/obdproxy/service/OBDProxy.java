 ...
 * 
 */
package com.braintech.obdproxy.service;
...
import com.braintech.obdproxy.ICommunicator;
import com.braintech.obdproxy.IProxyService;
import com.braintech.obdproxy.R;
import com.braintech.obdproxy.XMPPCommunicator;
import com.braintech.obdproxy.app.OBDproxyActivity;
import com.braintech.obdproxy.base.OBDConnector;
...
public class OBDProxy extends Service implements IProxyService {
    ...
    public void notifyUser(String action, String alert) {
        Toast.makeText(this, "Action: " + action + ", Alert: " + alert, Toast.LENGTH_LONG).show();
/*
...
*/
    ...
    private boolean bindToXMPPService() {
        Intent serviceIntent = new Intent(this, XMPPCommunicator.class);
        return bindService(serviceIntent, communicatorServiceConnection, Context.BIND_AUTO_CREATE);
    }
