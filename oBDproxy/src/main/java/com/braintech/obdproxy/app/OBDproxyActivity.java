package com.braintech.obdproxy.app;
...
import com.braintech.obdproxy.drawable.CoolantGaugeView;
import com.braintech.obdproxy.service.OBDProxy;
...
public class OBDproxyActivity extends Activity {
    ...
    protected void onResume() {
        ...
        super.onResume();
        if (!this.isBound) {
            Intent serviceIntent = new Intent(this, OBDProxy.class);
            this.isBound = this.bindService(serviceIntent, this.proxyServiceConnection, Context.BIND_AUTO_CREATE);
        }
